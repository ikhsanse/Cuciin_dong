...
public class DatabaseOpenHelper extends SQLiteOpenHelper {
    ...
    private static final String DATABASE_NAME = "cuciDong.db";
    ...
    DatabaseOpenHelper(Context context, String name, CursorFactory factory,
                       int version) {
    ...
    private static void initialize(Context context, String databaseName) {
        if (instance == null) {
            ...
            instance = new DatabaseOpenHelper(context, databaseName, null,
                    DATABASE_VERSION);
